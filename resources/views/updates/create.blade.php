...
@section('meta')
    <title>{{ __('New') }} | {{ __('Updates') }} | {{ config('app.name') }}</title>
@endsection
...
@section('content')
    <div class="card border-0 shadow">
        <div class="card-body">
            ...
            <p class="card-text">{{ __('Create a new update account.') }}</p>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-4">
                                <div class="btn-toolbar">
                                    ...
                                    @can('viewAny', App\Models\Update::class)
                                        <a class="btn btn-outline-dark ms-1" href="{{ route('updates.index') }}">
                                            {{ __('Cancel') }}
                                        </a>
                                    @endcan
                                </div>
